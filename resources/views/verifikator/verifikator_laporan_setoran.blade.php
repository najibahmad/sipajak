  ...
  <div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> <a href="{{url('verifikator')}}">Beranda</a>
                </li>
            </ol>
        </div>
    </div>

    <form class="form-horizontal" action="{{URL('verifikator/laporan_setoran/filter')}}" role="form" method="post">
