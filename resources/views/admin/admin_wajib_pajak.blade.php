...
@section('content')
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
        <form action="{{URL('admin/wajibPajak/tambahWajibPajak')}}" method="post">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <form id="editWajibPajak.{{$ini->id}}" action="{{URL('admin/wajibPajak/editWajibPajak')}}" method="post">
                        <input type="hidden" name="id" value="{{$ini->id}}">
                    </form>
                    <form id="hapusWajibPajak.{{$ini->id}}" action="{{URL('admin/wajibPajak/hapusWajibPajak')}}" method="post">
                        <input type="hidden" name="id" value="{{$ini->id}}">
                    </form>
                  </td>
                </tr>
