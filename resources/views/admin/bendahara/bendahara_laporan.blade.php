...
@section('content')
  <div class="container">
    ...
    <form class="form-horizontal" id="myform" action="{{URL('admin/laporan/filter')}}" role="form" method="post">
      ...
      <div class="form-group">
        <label class="control-label col-sm-2" for="kecamatan">Dari Tanggal:</label>
        <div class="col-sm-3">
          <input value="@if(isset($tgl_akhir)) {{$tgl_akhir}} @endif"  type="text" class="datepicker form-control" data-provide="datepicker" name="tgl_akhir" placeholder="Tanggal Akhir" required/>
        </div>
      </div>
      @if (isset($id))
